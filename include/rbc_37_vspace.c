...
/**
 * \fn void rbc_37_vspace_set(rbc_37_vspace o, const rbc_37_vspace vs, uint32_t size)
 * \brief This function copies a rbc_37_vspace to another one.
 *
 * \param[out] o rbc_37_vspace
 * \param[in] vs rbc_37_vspace
 * \param[in] size Size of the rbc_37_vspaces
 */
void rbc_37_vspace_set(rbc_37_vspace o, const rbc_37_vspace vs, uint32_t size) {
  rbc_37_vec_set(o, vs, size);
}
...
/**
 * \fn void rbc_37_vspace_set_zero(rbc_37_vspace o, uint32_t size)
 * \brief This function sets a rbc_37_vspace to zero.
 *
 * \param[out] o rbc_37_vspace
 * \param[in] size Size of the rbc_37_vspace
 */
...
/** 
 * \fn void rbc_37_vspace_set_random_full_rank(random_source* ctx, rbc_37_vspace o, uint32_t size)
...
void rbc_37_vspace_set_random_full_rank(random_source* ctx, rbc_37_vspace o, uint32_t size) {
  rbc_37_vec_set_random_full_rank(ctx, o, size);
}
...
/**
 * \fn void rbc_37_vspace_set_random_full_rank_with_one(random_source* ctx, rbc_37_vspace o, uint32_t size) {
 * \brief This function sets a rbc_37_vspace with random values using the NIST seed expander. The rbc_37_vspace returned by this function has full rank and contains one.
 *
...
void rbc_37_vspace_set_random_full_rank_with_one_tmp(seedexpander_shake_t* ctx, rbc_37_vspace o, uint32_t size) {
  rbc_37_vec_set_random_full_rank_with_one_tmp(ctx, o, size);
}
...
/**
 * \fn void rbc_37_vspace_direct_sum(rbc_37_vspace o, const rbc_37_vspace vs1, const rbc_37_vspace vs2, uint32_t vs1_size, uint32_t vs2_size)
 * \brief This function computes the direct sum of two vector spaces.
 *
 * \param[out] o Direct sum of vs1 and vs2
 * \param[in] vs1 rbc_37_vspace
 * \param[in] vs2 rbc_37_vspace
...
void rbc_37_vspace_direct_sum(rbc_37_vspace o, const rbc_37_vspace vs1, const rbc_37_vspace vs2, uint32_t vs1_size, uint32_t vs2_size) {
  for(size_t i = 0; i < vs1_size; i++) {
    rbc_37_elt_set(o[i], vs1[i]);
  }

  for(size_t i = 0; i < vs2_size; i++) {
    rbc_37_elt_set(o[i + vs1_size], vs2[i]);
  }
}
...
/**
 * \fn uint32_t rbc_37_vspace_intersection(rbc_37_vspace o, const rbc_37_vspace vs1, const rbc_37_vspace vs2, uint32_t vs1_size, uint32_t vs2_size)
...
uint32_t rbc_37_vspace_intersection(rbc_37_vspace o, const rbc_37_vspace vs1, const rbc_37_vspace vs2, uint32_t vs1_size, uint32_t vs2_size) {
  ...
  rbc_37_vspace direct_sum;
  rbc_37_vspace result;
  ...
  // Initialization
  rbc_37_vspace_init(&direct_sum, vs1_size + vs2_size);
  rbc_37_vspace_init(&result, vs1_size + vs2_size);

  rbc_37_vspace_direct_sum(direct_sum, vs1, vs2, vs1_size, vs2_size);
  rbc_37_vspace_set(result, vs1, vs1_size);
  rbc_37_vspace_set_zero(result + vs1_size, vs2_size);

  // Perform Gauss on direct_sum and repeat operations on result
  rbc_37_vec_gauss(direct_sum, vs1_size + vs2_size, 0, &result, 1);

  //Copy the generating set of the intersection
  rbc_37_vspace_set_zero(o, result_size);
  
  for(int32_t i = 0 ; i < result_size ; i++) {
    mask = rbc_37_elt_is_zero(direct_sum[vs1_size + vs2_size - result_size + i]);
    rbc_37_elt_set_mask1(o[i], result[vs1_size + vs2_size - result_size + i], zero, mask);
  }

  rbc_37_vspace_clear(direct_sum);
  rbc_37_vspace_clear(result);
...
/**
 * \fn void rbc_37_vspace_product(rbc_37_vspace o, const rbc_37_vspace vs1, const rbc_37_vspace vs2, uint32_t vs1_size, uint32_t vs2_size)
...
void rbc_37_vspace_product(rbc_37_vspace o, const rbc_37_vspace vs1, const rbc_37_vspace vs2, uint32_t vs1_size, uint32_t vs2_size) {
  for(size_t i = 0 ; i < vs1_size ; i++) {
    for(size_t j = 0 ; j < vs2_size ; j++) {
      rbc_37_elt_mul(o[i * vs2_size + j], vs1[i], vs2[j]);
    }
  }
}
...
/**
 * \fn void rbc_37_vspace_print(const rbc_37_vspace vs, uint32_t size)
 * \brief This function displays a rbc_37_vspace.
 *
 * \param[in] vs rbc_37_vspace
 * \param[in] size Size of the rbc_37_vspace
 */
void rbc_37_vspace_print(const rbc_37_vspace vs, uint32_t size) {
  rbc_37_vec_print(vs, size);
}
