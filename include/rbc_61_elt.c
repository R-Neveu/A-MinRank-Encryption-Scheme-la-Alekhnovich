/**
 * \file rbc_61_elt.c
 * \brief Implementation of rbc_61_elt.h
 */

#include "rbc_61.h"
#include "rbc_61_elt.h"

static uint8_t rbc_61_init_field = 0;
uint64_t RBC_61_SQR_LOOKUP_TABLE[256];



/**
 * \fn void rbc_61_field_init(void)
...
void rbc_61_field_init(void) {
  ...
  if(rbc_61_init_field == 0) {
    memset(RBC_61_SQR_LOOKUP_TABLE, 0, 8 * 256);
    for(size_t i = 0 ; i < 256 ; ++i) {
      for(size_t j = 0 ; j < 8 ; ++j) {
        mask = 1 << j;
        bit = (mask & i) >> j;
        RBC_61_SQR_LOOKUP_TABLE[i] ^= bit << (2 * j);
      }
    }
...
/**
 * \fn void rbc_61_elt_set_zero(rbc_61_elt o)
 * \brief This function sets a finite field element to zero.
 *
 * \param[out] o rbc_61_elt
 */
...
/**
 * \fn void rbc_61_elt_set_one(rbc_61_elt o)
...
/**
 * \fn void rbc_61_elt_set(rbc_61_elt o, const rbc_61_elt e)
 * \brief This function copies a finite field element into another one.
 *
 * \param[out] o rbc_61_elt
 * \param[in] e rbc_61_elt
 */
...
/**
* \fn void rbc_61_elt_set_mask1(rbc_61_elt o, const rbc_61_elt e1, const rbc_61_elt e2, uint32_t mask)
* \brief This function copies either e1 or e2 into o depending on the mask value
*
* \param[out] o rbc_61_elt
* \param[in] e1 rbc_61_elt
* \param[in] e2 rbc_61_elt_n* \param[in] mask 1 to copy e1 and 0 to copy e2
*/
void rbc_61_elt_set_mask1(rbc_61_elt o, const rbc_61_elt e1, const rbc_61_elt e2, uint32_t mask) {
  for(uint8_t i = 0 ; i < RBC_61_ELT_SIZE ; i++) {
    o[i] = mask * e1[i] + (1 - mask) * e2[i];
  }
}

/**
 * \fn void rbc_61_elt_set(rbc_61_elt o1, rbc_61_elt o2, const rbc_61_elt e, uint32_t mask)
 * \brief This function copies e either into o1 or o2 depending on the mask value
 *
 * \param[out] o1 rbc_61_elt
 * \param[out] o2 rbc_61_elt
 * \param[in] e rbc_61_elt
 * \param[in] mask 1 to copy into o1 and 0 to copy into o2
 */
void rbc_61_elt_set_mask2(rbc_61_elt o1, rbc_61_elt o2, const rbc_61_elt e, uint32_t mask) {
  for(uint8_t i = 0 ; i < RBC_61_ELT_SIZE ; i++) {
...
/**
 * \fn void rbc_61_elt_set_from_uint64(rbc_61_elt o, uint64_t* rbc_61_elt e)
 ...
 * \param[out] o rbc_61_elt
 */
void rbc_61_elt_set_random(random_source* ctx, rbc_61_elt o) {
  rbc_61_elt_set_zero(o);

  uint8_t random[RBC_61_ELT_UINT8_SIZE];
  random_source_get_bytes(ctx, random, RBC_61_ELT_UINT8_SIZE);
  random[RBC_61_ELT_UINT8_SIZE - 1] &= RBC_61_ELT_MASK;

  memcpy((uint64_t*) o, random, RBC_61_ELT_UINT8_SIZE);
}

/**
 * \fn uint8_t rbc_61_elt_is_zero(const rbc_61_elt e)
...
/**
 * \fn uint8_t rbc_61_elt_is_equal_to(const rbc_61_elt e1, const rbc_61_elt e2)
 * \brief This function tests if two finite field elements are equal.
 *
 * \param[in] e1 rbc_61_elt
 * \param[in] e2 rbc_61_elt
...
/**
 * \fn uint8_t rbc_61_elt_is_greater_than(const rbc_61_elt e1, const rbc_61_elt e2)
 ...
 */
uint8_t rbc_61_elt_is_greater_than(const rbc_61_elt e1, const rbc_61_elt e2) {
  return (e1[0] > e2[0]);
}

/**
 * \fn int32_t rbc_61_elt_get_degree(const rbc_61_elt e)
...
/**
 * \fn uint8_t rbc_61_elt_get_coefficient(const rbc_61_elt e, uint32_t index)
...
/**
 * \fn void rbc_61_elt_set_coefficient_vartime(rbc_61_elt o, uint32_t index, uint64_t bit)
...
/**
 * \fn rbc_61_elt_add(rbc_61_elt o, const rbc_61_elt e1, const rbc_61_elt e2)
...
/**
 * \fn void rbc_61_elt_mul(rbc_61_elt o, const rbc_61_elt e1, const rbc_61_elt e2)
...
void rbc_61_elt_mul(rbc_61_elt o, const rbc_61_elt e1, const rbc_61_elt e2) {
  rbc_61_elt_ur tmp;
  rbc_61_elt_ur_mul(tmp, e1, e2);
  rbc_61_elt_reduce(o, tmp);
}



/**
 * \fn rbc_61_elt_inv(rbc_61_elt o, const rbc_61_elt e)
 * \brief This function computes the multiplicative inverse of a finite field element.
 *
 * \param[out] o rbc_61_elt
 * \param[in] e rbc_61_elt
 */
void rbc_61_elt_inv(rbc_61_elt o, const rbc_61_elt e) {
  rbc_61_elt tmp;

  rbc_61_elt_set(tmp, e);
  for(int i = 0 ; i < (RBC_61_FIELD_M - 2) ; i++) {
    rbc_61_elt_sqr(o, tmp);
    rbc_61_elt_mul(tmp, o, e);
  }
  rbc_61_elt_sqr(o, tmp);
}
...
/**
 * \fn void rbc_61_elt_sqr(rbc_61_elt o, const rbc_61_elt e)
 * \brief This function computes the square of a finite field element.
 *
 * \param[out] o rbc_61_elt equal to \f$ e^{2} \f$
 * \param[in] e rbc_61_elt
 */
void rbc_61_elt_sqr(rbc_61_elt o, const rbc_61_elt e) {
  /*
  if(rbc_61_init_field == 0) {
    printf("Call to rbc_61_elt_sqr with uninitialized field\n");
    exit(1);
  }
  */

  rbc_61_elt_ur tmp;
  rbc_61_elt_ur_sqr(tmp, e);
  rbc_61_elt_reduce(o, tmp);
}

/**
 * \fn void rbc_61_elt_nth_root(rbc_61_elt o, const rbc_61_elt e, uint32_t n)
 ...
 */
void rbc_61_elt_nth_root(rbc_61_elt o, const rbc_61_elt e, uint32_t n) {
  uint32_t exp = n * (RBC_61_FIELD_M - 1) % RBC_61_FIELD_M;
...
/**
 * \fn void rbc_61_elt_reduce(rbc_61_elt o, const rbc_61_elt_ur e)
 * \brief This function reduces a finite field element.
 *
 * \param[out] o rbc_61_elt equal to $ e \pmod f $
 * \param[in] e rbc_61_elt
 */
void rbc_61_elt_reduce(rbc_61_elt o, const rbc_61_elt_ur e) {
  uint64_t tmp = (e[1] << 3) ^ (e[0] >> 61) ^ (e[1] >> 53) ^ (e[1] >> 56);
  o[0] = e[0] ^ tmp ^ (tmp << 1) ^ (tmp << 2) ^ (tmp << 5);
  o[0] &= 0x1FFFFFFFFFFFFFFF;
}

/**
 * \fn void rbc_61_elt_print(const rbc_61_elt e)
...
/**
 * \fn void rbc_61_elt_ur_set(rbc_61_elt_ur o, const rbc_61_elt_ur e)
...
void rbc_61_elt_ur_set(rbc_61_elt_ur o, const rbc_61_elt_ur e) {
  for(uint8_t i = 0 ; i < RBC_61_ELT_UR_SIZE ; i++) {
    o[i] = e[i];
  }
}

/**
 * \fn void rbc_61_elt_ur_set_zero(rbc_61_elt_ur o)
 * \brief This function sets an unreduced finite field element to zero.
 *
 * \param[out] o rbc_61_elt_ur
 */
...
/**
 * \fn void rbc_61_elt_ur_set_from_uint64(rbc_61_elt_ur o, uint64_t* e)
 * \brief This function set an unreduced finite field element from a pointer to uint64_t.
 *
 * \param[out] o rbc_61_elt_ur
 * \param[in] e Pointer to uint64_t
 */
void rbc_61_elt_ur_set_from_uint64(rbc_61_elt_ur o, const uint64_t* e) {
  rbc_61_elt_ur_set(o, e);
}

/**
 * \fn void rbc_61_elt_ur_mul(rbc_61_elt_ur o, const rbc_61_elt e1, const rbc_61_elt e2)
 * \brief This function computes the unreduced multiplication of two finite field elements.
 *
 * \param[out] o rbc_61_elt equal to \f$ e_1 \times e_2 $
 * \param[in] e1 rbc_61_elt
 * \param[in] e2 rbc_61_elt
 */
...
/**
 * \fn void rbc_61_elt_ur_sqr(rbc_61_elt o, const rbc_61_elt e)
 * \brief This function computes the unreduced square of a finite field element.
 *
 * \param[out] o rbc_61_elt_ur equal to $ e^{2} $
 * \param[in]  e rbc_61_elt
*/
void rbc_61_elt_ur_sqr(rbc_61_elt_ur o, const rbc_61_elt e) {
  ...
  e_l = _mm_and_si128(tmp, RBC_61_ELT_SQR_MASK_128);
  e_h = _mm_and_si128(_mm_srli_epi64(tmp, 4), RBC_61_ELT_SQR_MASK_128);

  e_l = _mm_shuffle_epi8(RBC_61_ELT_SQR_LOOKUP_TABLE_128, e_l);
  e_h = _mm_shuffle_epi8(RBC_61_ELT_SQR_LOOKUP_TABLE_128, e_h);
...
/**
 * \fn void rbc_61_elt_to_string(uint8_t* str, const rbc_61_elt e)
...
void rbc_61_elt_to_string(uint8_t* str, const rbc_61_elt e) {
  ...
  memset(str, 0, RBC_61_ELT_UINT8_SIZE);
  memcpy(str, e, bytes1);

  uint8_t k = 0;
  for(size_t j = 1 ; j <= bytes2 ; j++) {
    uint8_t bit = rbc_61_elt_get_coefficient(e, RBC_61_FIELD_M - j);
    *(str + bytes1) |= (bit << k % 8);
    k++;
    if(k % 8 == 0) bytes1++;
  }
...
/**
 * \fn void rbc_61_elt_from_string(rbc_61_elt e, const uint8_t* str)
 * \brief This function parses a string into a finite field element.
 *
 * \param[out] e rbc_61_elt
 * \param[in] str String to parse
 */
void rbc_61_elt_from_string(rbc_61_elt e, const uint8_t* str) {
  uint32_t bytes1 = RBC_61_FIELD_M / 8;
  uint32_t bytes2 = RBC_61_FIELD_M % 8;

  rbc_61_elt_set_zero(e);
  memcpy(e, str, bytes1);

  uint8_t k = 0;
  for(size_t j = 1 ; j <= bytes2 ; j++) {
    uint8_t bit = (str[bytes1] >> k % 8) & 0x01;
    rbc_61_elt_set_coefficient_vartime(e, RBC_61_FIELD_M - j, bit);
    k++;
    if(k % 8 == 0) bytes1++;
  }
}
...
/**
 * \fn void rbc_61_elt_ur_print(const rbc_61_elt_ur e)
 * \brief This function displays an unreduced finite field element.
 *
 * \param[in] e rbc_61_elt_ur
 */
void rbc_61_elt_ur_print(const rbc_61_elt_ur e) {
  printf("[");
  printf(" %16" PRIx64 , e[0]);
  printf(" ]");
}
