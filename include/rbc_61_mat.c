...
/**
 * \fn void rbc_61_mat_set_random(random_source* ctx, rbc_61_mat m, uint32_t rows, uint32_t columns)
 ...
 * \param[in] columns Column size of the rbc_61_mat
 */
void rbc_61_mat_set_random(random_source* ctx, rbc_61_mat m, uint32_t rows, uint32_t columns) {
    for(size_t i = 0 ; i < rows ; ++i) {
 ...
 * \param[in] columns Column size of the rbc_61_mat
 */
void rbc_61_mat_set_random_tmp(seedexpander_shake_t* ctx, rbc_61_mat m, uint32_t rows, uint32_t columns) {
    for(size_t i = 0 ; i < rows ; ++i) {
        rbc_61_vec_set_random_tmp(ctx, m[i], columns);
    }
}
...
/**
 * \fn void rbc_61_mat_vec_mul(rbc_61_vec o, const rbc_61_mat m, const rbc_61_vec v, uint32_t rows, uint32_t columns)
 ...
 */
void rbc_61_mat_vec_mul(rbc_61_vec o, const rbc_61_mat m, const rbc_61_vec v, uint32_t rows, uint32_t columns) {
    rbc_61_elt tmp, acc;
    for(size_t i = 0 ; i < rows ; ++i) {
        rbc_61_elt_set_zero(acc);
        for(size_t j = 0 ; j < columns ; ++j) {
...
/**
 * \fn void rbc_61_vec_mat_mul(rbc_61_vec o, const rbc_61_mat m, const rbc_61_vec v, uint32_t rows, uint32_t columns)
 * \brief This functions multiplies a matrix of finite field elements by a vector.
 *
 ...
 * \param[in] columns Column size of the rbc_61_mat
 */
void rbc_61_vec_mat_mul(rbc_61_vec o, const rbc_61_mat m, const rbc_61_vec v, uint32_t rows, uint32_t columns) {
    rbc_61_elt tmp, acc;
