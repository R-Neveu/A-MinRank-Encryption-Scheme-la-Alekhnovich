...
void rbc_61_mat_set_random(random_source* ctx, rbc_61_mat o, uint32_t rows, uint32_t columns);
void rbc_61_mat_set_random_tmp(seedexpander_shake_t* ctx, rbc_61_mat o, uint32_t rows, uint32_t columns);
