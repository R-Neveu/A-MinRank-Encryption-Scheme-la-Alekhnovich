/**
 * \file rbc_79_elt.c
 * \brief Implementation of rbc_79_elt.h
 */

#include "rbc_79.h"
#include "rbc_79_elt.h"

static uint8_t rbc_79_init_field = 0;
uint64_t RBC_79_SQR_LOOKUP_TABLE[256];



/**
 * \fn void rbc_79_field_init(void)
 * \brief This function initializes various constants used to perform finite field arithmetic.
 *
 */
void rbc_79_field_init(void) {
  uint8_t bit = 0;
  uint64_t mask = 0;

  if(rbc_79_init_field == 0) {
    memset(RBC_79_SQR_LOOKUP_TABLE, 0, 8 * 256);
    for(size_t i = 0 ; i < 256 ; ++i) {
      for(size_t j = 0 ; j < 8 ; ++j) {
        mask = 1 << j;
        bit = (mask & i) >> j;
        RBC_79_SQR_LOOKUP_TABLE[i] ^= bit << (2 * j);
      }
    }
...
/**
 * \fn void rbc_79_elt_set_zero(rbc_79_elt o)
 * \brief This function sets a finite field element to zero.
 *
 * \param[out] o rbc_79_elt
 */
void rbc_79_elt_set_zero(rbc_79_elt o) {
  for(uint8_t i = 0 ; i < RBC_79_ELT_SIZE ; i++) {
    o[i] = 0;
  }
}
...
/**
 * \fn void rbc_79_elt_set_one(rbc_79_elt o)
...
void rbc_79_elt_set_one(rbc_79_elt o) {
  o[0] = 1;
  for(uint8_t i = 1 ; i < RBC_79_ELT_SIZE ; i++) {
    o[i] = 0;
  }
}
...
/**
 * \fn void rbc_79_elt_set(rbc_79_elt o, const rbc_79_elt e)
 * \brief This function copies a finite field element into another one.
 *
 * \param[out] o rbc_79_elt
 * \param[in] e rbc_79_elt
 */
...
/**
* \fn void rbc_79_elt_set_mask1(rbc_79_elt o, const rbc_79_elt e1, const rbc_79_elt e2, uint32_t mask)
* \brief This function copies either e1 or e2 into o depending on the mask value
*
* \param[out] o rbc_79_elt
* \param[in] e1 rbc_79_elt
* \param[in] e2 rbc_79_elt_n* \param[in] mask 1 to copy e1 and 0 to copy e2
*/
...
/**
 * \fn void rbc_79_elt_set(rbc_79_elt o1, rbc_79_elt o2, const rbc_79_elt e, uint32_t mask)
 * \brief This function copies e either into o1 or o2 depending on the mask value
 *
 * \param[out] o1 rbc_79_elt
 * \param[out] o2 rbc_79_elt
 * \param[in] e rbc_79_elt
...
/**
 * \fn void rbc_79_elt_set_from_uint64(rbc_79_elt o, uint64_t* rbc_79_elt e)
...
void rbc_79_elt_set_random(random_source* ctx, rbc_79_elt o) {
  ...
  uint8_t random[RBC_79_ELT_UINT8_SIZE];
  random_source_get_bytes(ctx, random, RBC_79_ELT_UINT8_SIZE);
  random[RBC_79_ELT_UINT8_SIZE - 1] &= RBC_79_ELT_MASK;

  memcpy((uint64_t*) o, random, RBC_79_ELT_UINT8_SIZE);
}

/**
 * \fn uint8_t rbc_79_elt_is_zero(const rbc_79_elt e)
...
uint8_t rbc_79_elt_is_zero(const rbc_79_elt e) {
  int8_t result = 1;
  for(int i = RBC_79_ELT_DATA_SIZE - 1 ; i >= 0 ; i--) {
    result &= (e[i] == 0);
  }
...
/**
 * \fn uint8_t rbc_79_elt_is_equal_to(const rbc_79_elt e1, const rbc_79_elt e2)
 * \brief This function tests if two finite field elements are equal.
 *
 * \param[in] e1 rbc_79_elt
 * \param[in] e2 rbc_79_elt
...
uint8_t rbc_79_elt_is_equal_to(const rbc_79_elt e1, const rbc_79_elt e2) {
  int8_t result = 1;
  for(uint8_t i = 0 ; i < RBC_79_ELT_DATA_SIZE ; i++) {
    result &= (e1[i] == e2[i]);
  }
 return result;
}
...
/**
 * \fn uint8_t rbc_79_elt_is_greater_than(const rbc_79_elt e1, const rbc_79_elt e2)
...
uint8_t rbc_79_elt_is_greater_than(const rbc_79_elt e1, const rbc_79_elt e2) {
  ...
  for(int8_t i = RBC_79_ELT_DATA_SIZE - 1 ; i >= 0 ; i--) {
    tmp = (e1[i] > e2[i]);
...
/**
 * \fn int32_t rbc_79_elt_get_degree(const rbc_79_elt e)
...
/**
 * \fn uint8_t rbc_79_elt_get_coefficient(const rbc_79_elt e, uint32_t index)
 ...
 */
uint8_t rbc_79_elt_get_coefficient(const rbc_79_elt e, uint32_t index) {
  uint64_t w = 0;
...
/**
 * \fn void rbc_79_elt_set_coefficient_vartime(rbc_79_elt o, uint32_t index, uint64_t bit)
...
/**
 * \fn rbc_79_elt_add(rbc_79_elt o, const rbc_79_elt e1, const rbc_79_elt e2)
...
/**
 * \fn void rbc_79_elt_mul(rbc_79_elt o, const rbc_79_elt e1, const rbc_79_elt e2)
...
void rbc_79_elt_mul(rbc_79_elt o, const rbc_79_elt e1, const rbc_79_elt e2) {
  rbc_79_elt_ur tmp;
  rbc_79_elt_ur_mul(tmp, e1, e2);
  rbc_79_elt_reduce(o, tmp);
}



/**
 * \fn rbc_79_elt_inv(rbc_79_elt o, const rbc_79_elt e)
...
void rbc_79_elt_inv(rbc_79_elt o, const rbc_79_elt e) {
  ...
  rbc_79_elt_set(tmp, e);
  for(int i = 0 ; i < (RBC_79_FIELD_M - 2) ; i++) {
    rbc_79_elt_sqr(o, tmp);
    rbc_79_elt_mul(tmp, o, e);
  }
  rbc_79_elt_sqr(o, tmp);
}
...
/**
 * \fn void rbc_79_elt_sqr(rbc_79_elt o, const rbc_79_elt e)
 * \brief This function computes the square of a finite field element.
 *
 * \param[out] o rbc_79_elt equal to \f$ e^{2} \f$
 * \param[in] e rbc_79_elt
 */
void rbc_79_elt_sqr(rbc_79_elt o, const rbc_79_elt e) {
  /*
  if(rbc_79_init_field == 0) {
    printf("Call to rbc_79_elt_sqr with uninitialized field\n");
    exit(1);
  }
  */

  rbc_79_elt_ur tmp;
  rbc_79_elt_ur_sqr(tmp, e);
  rbc_79_elt_reduce(o, tmp);
}

/**
 * \fn void rbc_79_elt_nth_root(rbc_79_elt o, const rbc_79_elt e, uint32_t n)
...
void rbc_79_elt_nth_root(rbc_79_elt o, const rbc_79_elt e, uint32_t n) {
  uint32_t exp = n * (RBC_79_FIELD_M - 1) % RBC_79_FIELD_M;
...
/**
 * \fn void rbc_79_elt_reduce(rbc_79_elt o, const rbc_79_elt_ur e)
 * \brief This function reduces a finite field element.
 *
 * \param[out] o rbc_79_elt equal to $ e \pmod f $
 * \param[in] e rbc_79_elt
 */
...
/**
 * \fn void rbc_79_elt_print(const rbc_79_elt e)
...
/**
 * \fn void rbc_79_elt_ur_set(rbc_79_elt_ur o, const rbc_79_elt_ur e)
...
void rbc_79_elt_ur_set(rbc_79_elt_ur o, const rbc_79_elt_ur e) {
  for(uint8_t i = 0 ; i < RBC_79_ELT_UR_SIZE - 1 ; i++) {
    o[i] = e[i];
  }
  o[RBC_79_ELT_SIZE - 1] = 0;
}

/**
 * \fn void rbc_79_elt_ur_set_zero(rbc_79_elt_ur o)
 * \brief This function sets an unreduced finite field element to zero.
 *
 * \param[out] o rbc_79_elt_ur
 */
void rbc_79_elt_ur_set_zero(rbc_79_elt_ur o) {
  for(uint8_t i = 0 ; i < RBC_79_ELT_UR_SIZE ; i++) {
    o[i] = 0;
  }
}

/**
 * \fn void rbc_79_elt_ur_set_from_uint64(rbc_79_elt_ur o, uint64_t* e)
...
void rbc_79_elt_ur_set_from_uint64(rbc_79_elt_ur o, const uint64_t* e) {
  rbc_79_elt_ur_set(o, e);
}

/**
 * \fn void rbc_79_elt_ur_mul(rbc_79_elt_ur o, const rbc_79_elt e1, const rbc_79_elt e2)
 * \brief This function computes the unreduced multiplication of two finite field elements.
 *
 * \param[out] o rbc_79_elt equal to \f$ e_1 \times e_2 $
 * \param[in] e1 rbc_79_elt
 * \param[in] e2 rbc_79_elt
 */
...
/**
 * \fn void rbc_79_elt_ur_sqr(rbc_79_elt o, const rbc_79_elt e)
 * \brief This function computes the unreduced square of a finite field element.
 *
 * \param[out] o rbc_79_elt_ur equal to $ e^{2} $
 * \param[in]  e rbc_79_elt
*/
void rbc_79_elt_ur_sqr(rbc_79_elt_ur o, const rbc_79_elt e) {
  ...
  e_l = _mm_and_si128(tmp1, RBC_79_ELT_SQR_MASK_128);
  e_h = _mm_and_si128(_mm_srli_epi64(tmp1, 4), RBC_79_ELT_SQR_MASK_128);

  e_l = _mm_shuffle_epi8(RBC_79_ELT_SQR_LOOKUP_TABLE_128, e_l);
  e_h = _mm_shuffle_epi8(RBC_79_ELT_SQR_LOOKUP_TABLE_128, e_h);
...
/**
 * \fn void rbc_79_elt_to_string(uint8_t* str, const rbc_79_elt e)
 * \brief This function parses a finite field element into a string.
 *
 * \param[out] str Output string
 * \param[in] e rbc_79_elt
 */
void rbc_79_elt_to_string(uint8_t* str, const rbc_79_elt e) {
  uint32_t bytes1 = RBC_79_FIELD_M / 8;
  uint32_t bytes2 = RBC_79_FIELD_M % 8;

  memset(str, 0, RBC_79_ELT_UINT8_SIZE);
  memcpy(str, e, bytes1);

  uint8_t k = 0;
  for(size_t j = 1 ; j <= bytes2 ; j++) {
    uint8_t bit = rbc_79_elt_get_coefficient(e, RBC_79_FIELD_M - j);
    *(str + bytes1) |= (bit << k % 8);
    k++;
    if(k % 8 == 0) bytes1++;
  }
...
/**
 * \fn void rbc_79_elt_from_string(rbc_79_elt e, const uint8_t* str)
 * \brief This function parses a string into a finite field element.
 *
 * \param[out] e rbc_79_elt
 * \param[in] str String to parse
 */
void rbc_79_elt_from_string(rbc_79_elt e, const uint8_t* str) {
  uint32_t bytes1 = RBC_79_FIELD_M / 8;
  uint32_t bytes2 = RBC_79_FIELD_M % 8;

  rbc_79_elt_set_zero(e);
  memcpy(e, str, bytes1);

  uint8_t k = 0;
  for(size_t j = 1 ; j <= bytes2 ; j++) {
    uint8_t bit = (str[bytes1] >> k % 8) & 0x01;
    rbc_79_elt_set_coefficient_vartime(e, RBC_79_FIELD_M - j, bit);
    k++;
    if(k % 8 == 0) bytes1++;
  }
}
...
/**
 * \fn void rbc_79_elt_ur_print(const rbc_79_elt_ur e)
 * \brief This function displays an unreduced finite field element.
 *
 * \param[in] e rbc_79_elt_ur
 */
