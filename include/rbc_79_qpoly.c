/** 
 * \file rbc_79_qpoly.c
 * \brief Implementation of rbc_79_qpoly.h
 *
...
/** 
 * \fn void rbc_79_qpoly_init(rbc_79_qpoly* p, int32_t max_degree)
...
void rbc_79_qpoly_init(rbc_79_qpoly* p, int32_t max_degree) {
  *p = malloc(sizeof(rbc_79_qpoly_struct));

  rbc_79_vec_init(&((*p)->values), max_degree + 1);
...
/** 
 * \fn void rbc_79_qpoly_update_degree(rbc_79_qpoly p, int32_t position)
 * \brief This function updates the degree of a rbc_79_qpoly starting from a given position.
 *
...
void rbc_79_qpoly_update_degree(rbc_79_qpoly p, int32_t position) {
  for(int32_t i = position ; i >= 0 ; --i) {
    if(rbc_79_elt_is_zero(p->values[i]) == 0) { 
      p->degree = i;
      return;
    }
  }
...
/** 
 * \fn int8_t rbc_79_qpoly_set(rbc_79_qpoly o, const rbc_79_qpoly p)
...
int8_t rbc_79_qpoly_set(rbc_79_qpoly o, const rbc_79_qpoly p) {
  ...
  for(int32_t i = 0 ; i <= p->degree ; ++i) {
    rbc_79_elt_set(o->values[i], p->values[i]);
  }

  for(int32_t i = p->degree + 1 ; i <= o->max_degree ; ++i) {
    rbc_79_elt_set_zero(o->values[i]);
  }
...
/** 
 * \fn int8_t rbc_79_qpoly_set_mask(rbc_79_qpoly o, const rbc_79_qpoly p1, const rbc_79_qpoly p2, uint32_t mask)
...
int8_t rbc_79_qpoly_set_mask(rbc_79_qpoly o, const rbc_79_qpoly p1, const rbc_79_qpoly p2, uint32_t mask) {
  ...
  for(int32_t i = 0 ; i <= o->degree ; ++i) {
    rbc_79_elt_set_mask1(o->values[i], p1->values[i], p2->values[i], mask);
  }
...
/** 
 * \fn int8_t rbc_79_qpoly_set_zero(rbc_79_qpoly o)
...
int8_t rbc_79_qpoly_set_zero(rbc_79_qpoly o) {
  o->degree = -1;
  rbc_79_vec_set_zero(o->values, o->max_degree + 1);
...
/** 
 * \fn int8_t rbc_79_qpoly_set_one(rbc_79_qpoly o)
...
/**
 * \fn int8_t rbc_79_qpoly_set_interpolate_vect_and_zero(rbc_79_qpoly o1, rbc_79_qpoly o2, const rbc_79_vec& p1, const rbc_79_vec& p2, int32_t size);
 ...
 *
 * \param[out] o1 rbc_79_qpoly such that \f$ o1(p1_i) = 0 \f$ with \f$ 0 \leq i \leq size - 1 \f$
 * \param[out] o2 rbc_79_qpoly such that \f$ o2(p1_i) = p2_i \f$ with \f$ 0 \leq i \leq size - 1 \f$
...
int8_t rbc_79_qpoly_set_interpolate_vect_and_zero(rbc_79_qpoly o1, rbc_79_qpoly o2, const rbc_79_poly p1, const rbc_79_poly p2, int32_t size) {
  ...
  rbc_79_elt tmp1, tmp2, tmp3;

  rbc_79_qpoly qtmp;
  rbc_79_qpoly_init(&qtmp, size);

  rbc_79_qpoly_set_one(o1);
  rbc_79_qpoly_set_zero(o2);
  rbc_79_qpoly_set_zero(qtmp);

  for(int32_t i = 0 ; i < size ; ++i)  {
    rbc_79_qpoly_evaluate(tmp1, o1, p1->v[i]);
    rbc_79_qpoly_evaluate(tmp2, o2, p1->v[i]);

    rbc_79_elt_inv(tmp3, tmp1);
    rbc_79_elt_add(tmp2, tmp2, p2->v[i]);
    rbc_79_elt_mul(tmp2, tmp2, tmp3);

    rbc_79_qpoly_scalar_mul(qtmp, o1, tmp2);
    rbc_79_qpoly_add(o2, qtmp, o2);

    rbc_79_qpoly_qexp(qtmp, o1);
    rbc_79_qpoly_scalar_mul(o1, o1, tmp1);
    rbc_79_qpoly_add(o1, o1, qtmp);
  }

  rbc_79_qpoly_clear(qtmp);
...
/**
 * \fn int8_t rbc_79_qpoly_annulator(rbc_79_qpoly p, const rbc_79_vec v, uint32_t size)
...
int8_t rbc_79_qpoly_annihilator(rbc_79_qpoly p, const rbc_79_vec v, int32_t size) {
  ...
  rbc_79_elt p_at_vi;
  rbc_79_qpoly t;
  rbc_79_qpoly_init(&t, size);
  rbc_79_qpoly_set_zero(t);

  // We initialise p as x
  rbc_79_qpoly_set_one(p);

  int i;
  for(i = 0; i < size; ++i) {
    rbc_79_qpoly_evaluate(p_at_vi, p, v[i]);   // p_i(v_i)
    rbc_79_qpoly_qexp(t, p);                   // (p_i^q)(x)
    rbc_79_qpoly_scalar_mul(p, p, p_at_vi);    // (p_i(v_i) * p_i)(x)
    rbc_79_qpoly_add(p, p, t);                 // (p_i^q + p_i(v_i) * p_i)(x)
  }

  rbc_79_elt_set_zero(p_at_vi);
  rbc_79_qpoly_clear(t);
...
/** 
 * \fn int8_t rbc_79_qpoly_is_zero(const rbc_79_qpoly p)
...
/** 
 * \fn void rbc_79_qpoly_evaluate(rbc_79_elt o, const rbc_79_qpoly p, const rbc_79_elt e)
...
void rbc_79_qpoly_evaluate(rbc_79_elt o, const rbc_79_qpoly p, const rbc_79_elt e) {
  rbc_79_elt tmp1, tmp2;

  rbc_79_elt_set(tmp1, e);
  rbc_79_elt_mul(o, p->values[0], tmp1);

  for(int32_t i = 1 ; i <= p->degree ; ++i) {
    rbc_79_elt_sqr(tmp1, tmp1);
    rbc_79_elt_mul(tmp2, p->values[i], tmp1);
    rbc_79_elt_add(o, o, tmp2);
  }
}
...
/** 
 * \fn int8_t rbc_79_qpoly_scalar_mul(rbc_79_qpoly o, const rbc_79_qpoly p, const rbc_79_elt e)
...
int8_t rbc_79_qpoly_scalar_mul(rbc_79_qpoly o, const rbc_79_qpoly p, const rbc_79_elt e) {
  ...
  rbc_79_elt tmp;
  for(int32_t i = 0 ; i <= p->degree ; ++i) {
    rbc_79_elt_mul(tmp, p->values[i], e);
    rbc_79_elt_set(o->values[i], tmp);
  }
...
/** 
 * \fn int8_t rbc_79_qpoly_qexp(rbc_79_qpoly o, const rbc_79_qpoly p)
...
int8_t rbc_79_qpoly_qexp(rbc_79_qpoly o, const rbc_79_qpoly p) {
  ...
  rbc_79_elt tmp;
  rbc_79_elt_set_zero(o->values[0]);
  for(int32_t i = 0 ; i <= p->degree ; ++i) {
    rbc_79_elt_sqr(tmp, p->values[i]);
    rbc_79_elt_set(o->values[(i + 1) % RBC_79_FIELD_M], tmp);
  }
  ...
  rbc_79_qpoly_update_degree(o, p->degree + 1);
...
/** 
 * \fn int8_t rbc_79_qpoly_add(rbc_79_qpoly o, const rbc_79_qpoly p1, const rbc_79_qpoly p2)
...
int8_t rbc_79_qpoly_add(rbc_79_qpoly o, const rbc_79_qpoly p1, const rbc_79_qpoly p2) {
  ...
  for(int32_t i = 0 ; i <= o->degree ; ++i) {
    rbc_79_elt_add(o->values[i], p1->values[i], p2->values[i]);
  }
  ...
  rbc_79_qpoly_update_degree(o, o->degree);
...
/** 
 * \fn int8_t rbc_79_qpoly_mul(rbc_79_qpoly o, const rbc_79_qpoly p1, const rbc_79_qpoly p2)
...
int8_t rbc_79_qpoly_mul(rbc_79_qpoly o, const rbc_79_qpoly p1, const rbc_79_qpoly p2) {
  ...
  rbc_79_qpoly_set_zero(o);
  rbc_79_elt tmp1, tmp2;

  for(int32_t j = 0 ; j <= p2->degree ; ++j) {
    rbc_79_elt_set(tmp1, p2->values[j]);
    rbc_79_elt_mul(tmp2, p1->values[0], tmp1);
    rbc_79_elt_add(o->values[j], o->values[j], tmp2);
    for(int32_t i = 1 ; i <= p1->degree ; ++i) {
      rbc_79_elt_sqr(tmp1, tmp1);
      rbc_79_elt_mul(tmp2, p1->values[i], tmp1);
      rbc_79_elt_add(o->values[(i + j) % RBC_79_FIELD_M], o->values[(i + j) % RBC_79_FIELD_M], tmp2); 
    }
  }

  rbc_79_qpoly_update_degree(o, p1->degree + p2->degree);
...
/** 
 * \fn int8_t rbc_79_qpoly_mul2(rbc_79_qpoly o, const rbc_79_qpoly p1, const rbc_79_qpoly p2, uint32_t p1_degree, uint32_r p2_degree)
 * \brief This function computes the multiplication of two q_polynomials.
 *
 * Multiplication of two q_polynomials is non commutative and is defined using composition namely \f$ p \times q = p \circ q \f$.
 * Execution time of this function depends on p1_degree and p2_degree rather than p1->degree and p2->degree as in rbc_79_qpoly_mul.
 *
 * \param[out] o q_poynomial equal to \f$ p1 \circ p2 \f$
 * \param[in] p1 q_polynomial
 * \param[in] p2 q_polynomial
...
/** 
 * \fn int8_t rbc_79_qpoly_left_div(rbc_79_qpoly q, rbc_79_qpoly r, const rbc_79_qpoly a, const rbc_79_qpoly b)
...
int8_t rbc_79_qpoly_left_div(rbc_79_qpoly q, rbc_79_qpoly r, const rbc_79_qpoly a, const rbc_79_qpoly b) {
  if(q->max_degree < a->degree - b->degree || r->max_degree < b->degree - 1 || rbc_79_qpoly_is_zero(b)) {
    return INVALID_PARAMETERS;
  }
  ...
  rbc_79_qpoly_init(&rtmp, a->degree);
  rbc_79_qpoly_init(&s, a->degree - b->degree);
  rbc_79_qpoly_init(&t, a->max_degree);

  rbc_79_qpoly_set_zero(q);
  rbc_79_qpoly_set(rtmp, a);

  rbc_79_elt b_lead_coeff_inv;
  rbc_79_elt r_lead_coeff;
  rbc_79_elt s_lead_coeff;

  rbc_79_elt_set(b_lead_coeff_inv, b->values[b->degree]);
  rbc_79_elt_inv(b_lead_coeff_inv, b_lead_coeff_inv);

  while(rtmp->degree >= b->degree) {

    // Compute monial s
    rbc_79_elt_set(r_lead_coeff, rtmp->values[rtmp->degree]);
    rbc_79_elt_mul(s_lead_coeff, r_lead_coeff, b_lead_coeff_inv);
    rbc_79_elt_nth_root(s_lead_coeff, s_lead_coeff, b->degree);

    rbc_79_qpoly_set_zero(s);
    rbc_79_elt_set(s->values[rtmp->degree - b->degree], s_lead_coeff);
    s->degree = rtmp->degree - b->degree;

    // Update quotient rbc_79_qpoly
    rbc_79_qpoly_add(q, q, s);

    // Update remainder rbc_79_qpoly
    rbc_79_qpoly_mul(t, b, s);
    rbc_79_qpoly_add(rtmp, rtmp, t);

  }

  rbc_79_qpoly_set(r, rtmp);

  rbc_79_qpoly_clear(rtmp);
  rbc_79_qpoly_clear(s);
  rbc_79_qpoly_clear(t);
...
/** 
 * \fn int8_t rbc_79_qpoly_left_div(rbc_79_qpoly q, rbc_79_qpoly r, const rbc_79_qpoly a, const rbc_79_qpoly b, uint32_t capacity, uint32_t k)
 * \brief This function computes the left division of two q_polynomials using euclidean algorithm: \f$ a = b \times q + r \f$.
 *
 * This function is a variant of rbc_79_qpoly_left_div that uses rbc_79_poly_mul2
 *
 * \param[out] q q_polynomial equal to the quotient of the division
 * \param[out] r q_polynomial equal to the remainder of the division
 * \param[in] a q_polynomial to divide
...
int8_t rbc_79_qpoly_left_div2(rbc_79_qpoly q, rbc_79_qpoly r, const rbc_79_qpoly a, const rbc_79_qpoly b, uint32_t capacity, uint32_t k) {
  ...
  while(rtmp->degree >= b->degree) {
    ...
    // Update remainder rbc_79_qpoly
    rbc_79_qpoly_mul2(t, b, s, capacity, i);
    rbc_79_qpoly_add(rtmp, rtmp, t);
